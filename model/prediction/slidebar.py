...
def sideBar():
    ...
    with st.sidebar:
        ...
        #         default_index=0,
        #     )
        #     return df_lat_lon_filtered, selected_district,selected_color_theme, analytics_option
    ...
    return df_lat_lon_filtered,selected_district,selected_color_theme, None